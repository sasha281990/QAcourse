...
item_1 = 9
# 20. Присвоить переменной item_2 even значение (четный).
item_2 = 4
...
print(result_division_loss)
    ...
    # Реализация через арифметические действия с присвоением.
...
try:
    ...
    print(b_item_relult_division, 'Ошибки нет.')
except ZeroDivisionError:
    #b_item_relult_division = b_item_f
    print('Ошибка исключена из кода.')
